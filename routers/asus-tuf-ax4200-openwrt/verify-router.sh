...
load_profile_defaults "$(router_profile_dir "$ROOT_DIR" "${ROUTER_PROFILE:-asus-tuf-ax4200-openwrt}")/profile.env"
...
# Stock OpenWrt has no hardware switch — treat the path as always requested.
switch_state="on"
