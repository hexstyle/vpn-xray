...
EOF
	...
	normalize_installed_text_files \
		...
		/www/xray-tree.js \
		/www/xray.html
	chmod 755 /etc/init.d/codex-xray /etc/init.d/codex-transproxy /etc/hotplug.d/iface/95-codex-xray-uplink /etc/hotplug.d/iface/96-codex-ra0-guard /etc/init.d/xray-switch-watchdog /etc/init.d/xray-health-monitor /etc/init.d/xray-uplink-guard /usr/bin/vpn-xray-uplink-guard /etc/init.d/router-rules-sync /etc/gl-switch.d/xray.sh /usr/bin/router-rules /usr/bin/vpn-xray-repin-cert /usr/share/vpn-xray/lib-common.sh /usr/share/vpn-xray/xray-admin-probe.sh /usr/share/vpn-xray/xray-admin-status.sh /usr/share/vpn-xray/xray-diag-capture.sh /usr/share/vpn-xray/xray-rules-jobs.sh /usr/share/vpn-xray/xray-rules-actions.sh /usr/share/vpn-xray/xray-rules-scripts.sh /usr/share/vpn-xray/xray-vps-profile.sh /usr/share/vpn-xray/xray-vps-ssh.sh /usr/share/vpn-xray/xray-vps-render.sh /usr/share/vpn-xray/xray-vps-inspect.sh /usr/share/vpn-xray/xray-vps-actions.sh /usr/share/vpn-xray/xray-vps-setup.sh /usr/share/vpn-xray/xray-vps-repair.sh /usr/share/vpn-xray/router-rules-external.py /usr/share/vpn-xray/router-rules-config.sh /usr/share/vpn-xray/router-rules-git.sh /usr/share/vpn-xray/router-rules-repo.sh /usr/share/vpn-xray/router-rules-remote.sh /usr/share/vpn-xray/router-rules-rulestree.sh /usr/share/vpn-xray/router-rules-external-a.sh /usr/share/vpn-xray/router-rules-external-b.sh /usr/share/vpn-xray/router-rules-ipset.sh /usr/share/vpn-xray/router-rules-apply.sh /usr/share/vpn-xray/router-rules-status.sh /www/cgi-bin/xray-admin /www/cgi-bin/xray-vps /www/cgi-bin/xray-rules
