...
case "$target" in
  router)
    ...
    require_vars ROUTER_HOST XRAY_SERVER XRAY_UUID XRAY_SERVER_NAME XRAY_PUBLIC_KEY XRAY_SHORT_ID
    reject_placeholder_vars \
      ROUTER_HOST XRAY_SERVER XRAY_UUID XRAY_SERVER_NAME XRAY_PUBLIC_KEY XRAY_SHORT_ID
    ;;
  vps)
